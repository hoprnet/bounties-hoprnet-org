...
const AboutUsPage: NextPage = () => {
  return (
    <div>
      ...
      <div style={{ ...styles.titleStyle, padding: "200px 0px" }}>ABOUT</div>
      <div style={{ ...styles.titleStyle, paddingBottom: 40 }}>
      ...
      <div style={{ ...styles.titleStyle, paddingBottom: 30 }}>ABOUT HOPR</div>
      <div style={styles.videoRow}>
        ...
        <div>
          ...
          <div>HOPR website, HOPR on GitHub</div>
        </div>
      </div>
      <Footer />
    </div>
